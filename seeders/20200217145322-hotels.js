...
module.exports = {
  up: (queryInterface, Sequelize) => {
      ...
      
    {
      ...
      "img_url": "",
      "eco_friendly": true,
      "description": "W New York Times Square is located in New York City's Times Square. This hotel is a short walk from Broadway theaters of Theater District. It features an on-site restaurant.",
      "wifi": true,
      "business": true,
      "laundry": true,
      "smoke_free": true,
    ...
    
    {
      ...
      "img_url": "",
      "eco_friendly": false,
      "description": "Within the L.A. LIVE entertainment complex, this posh hotel is a 5-minute walk from the Staples Center, home of the Lakers and Clippers, and 1.4 miles from The Walt Disney Concert Hall.",
      "wifi": true,
      "business": true,
      "laundry": false,
      "smoke_free": false,
